...
[ ●━◉⟞⟦ 𝘼𝙑𝘼𝙏𝘼𝙍 ⟧⟝◉━● •](https://t.me/sourceav)""", reply_markup=InlineKeyboardMarkup(
   ...
   kep = ReplyKeyboardMarkup([["《مطور البوت》", "《مطور السورس》"], ["《اضافه البوت لمجموعتك》"], ["《السورس》", "《جروب السورس》"], ["✨بنك قيصر", "⋖━❲𖣂❳━⋗", "✨ابراج"], ["✨ازكار", "⋖━❲𖣂❳━⋗", "✨اسال"], ["●━◉⟞⟦ 𝘼𝙑𝘼𝙏𝘼𝙍 ⟧⟝◉━●"], ["زخرفه", "⋖━❲𖣂❳━⋗", "✨زخارف"], ["✨حكمه", "⋖━❲𖣂❳━⋗", "✨معلومات"], ["✨العاب", "⋖━❲𖣂❳━⋗", "✨اغاني"], ["✨مهنتي", "⋖━❲𖣂❳━⋗", "✨افلام"], ["✨كت", "⋖━❲𖣂❳━⋗", "✨تويت"], ["✨رايك بصورتي", "⋖━❲𖣂❳━⋗", "✨حساب العمر"], ["●━◉⟞⟦ 𝘼𝙑𝘼𝙏𝘼𝙍 ⟧⟝◉━●"], ["✨حذف حسابي", "⋖━❲𖣂❳━⋗", "✨انصحني"], ["✨مميزات", "⋖━❲𖣂❳━⋗", "✨بوت"], ["✨نكته", "⋖━❲𖣂❳━⋗", "✨حروف"], ["✨صوره", "⋖━❲𖣂❳━⋗", "✨غنيلي"], ["✨انمي", "⋖━❲𖣂❳━⋗", "✨متحركه"], ["✨اقتباسات", "⋖━❲𖣂❳━⋗", "✨هيدرات"], ["●━◉⟞⟦ 𝘼𝙑𝘼𝙏𝘼𝙍 ⟧⟝◉━●"], ["✨صور بنات", "⋖━❲𖣂❳━⋗", "✨صور شباب"], ["✨قران", "⋖━❲𖣂❳━⋗", "✨الشيخ نقشبندي"], ["✨استوريهات", "⋖━❲𖣂❳━⋗", "✨فيلم"], ["✨ايدي", "⋖━❲𖣂❳━⋗", "✨خيرني"], ["🥺 ¦ حذف الكيبورد"]], resize_keyboard=True)
   await m.reply_photo(
        photo=f"https://telegra.ph/file/26b3058026045839af45d.jpg",
        caption=f"""[ ●━◉⟞⟦ 𝘼𝙑𝘼𝙏𝘼𝙍 ⟧⟝◉━● •](https://t.me/sourceav)\n\n**اهـلا يـنـجـم.؟ **\n**مـرحبآ بـك انــا بــوت اقـوم بــتـشـغـيـل الاغــانــي فـي الـمـڪـالـمـه الـصـوتـية .🤔❤**\n**يمكنني التشغيل بصوت رائع وبدون اي مشاكل او تقطيع في الاغنيه**\n**اضفني الى مجموعتك وارفعني رول بشڪل مع ڪامل الصلاحيات صحيح**\n**لمعرفة استخدامي بشڪل صحيح اضغط علي زر الاوامر. 🤔💕**\n
  ...
  if m.text in admins_commands:
    if not check(m.from_user.id):
      ...
      if m.text == '《ضع قناة الاشتراك》':
        await m.reply("• ارسل معرف القناة العام مثال @sourceav", quote=True)
        ...
        if len(get_admins()) == 0:
          ...
          for admin in get_admins():
            try:
              ...
              text += f'• [@sourceav](tg://user?id={admin})\n'
          await m.reply(text, quote=True)
...
@app.on_message(filters.command(["●━◉⟞⟦ 𝘼𝙑𝘼𝙏𝘼𝙍 ⟧⟝◉━●"], ""))
async def upbkgt(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/26b3058026045839af45d.jpg",
        caption=f"""صلي علي النبي وتبسم ✨💖""",
...
async def upbkgt(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/26b3058026045839af45d.jpg",
        caption=f"""قم باضافتي لمجوموعتك لتشغيل الموسيقي والفديو في المحادثه الصوتيه انا من اسرع البوتات التي تستطيع تشغيل الاغاني تم تنصيبي في افضل سورس في التلجرام سورس القيصر قناه السورس @sourceav""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
