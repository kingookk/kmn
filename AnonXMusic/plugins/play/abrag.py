...
async def abrag(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("القوس", callback_data="elqoos " + str(m.from_user.id))],
         [InlineKeyboardButton("𝐎ꪶ𝐋ٓ𝐄𝐕ِ𝐑┊͙🚸ݪـي٘فـࢪꪆُﺎ", url=f"https://t.me/L_HLN")],
         [InlineKeyboardButton("𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙑𝘼𝙏𝘼𝙍", url=f"https://t.me/sourceav")],
...
مقدم من سورس اڤـتار 🌹   https://t.me/sourceav"""
